...
uint256 constant NO_TRANSFER_MANAGER_APPROVAL_BY_USER_FOR_EXCHANGE = 541; // OK
uint256 constant TRANSFER_MANAGER_APPROVAL_REVOKED_BY_OWNER_FOR_EXCHANGE = 542; // OK
...
// 7. Creator fee-related errors
uint256 constant CREATOR_FEE_TOO_HIGH = 701;
