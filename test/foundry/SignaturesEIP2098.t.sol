...
contract SignaturesEIP2098Test is ProtocolBase {
    ...
    function testFuzz_CanSignValidMakerAskEIP2098(uint256 price, uint256 itemId) public {
    ...
    function testFuzz_CanSignValidMakerBidEIP2098(uint256 price, uint256 itemId) public {
        vm.assume(price <= 2 ether);
